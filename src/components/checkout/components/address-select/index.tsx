  ...
  return (
    <Listbox onChange={handleSelect} value={selected}>
      <div className="relative">
        <Listbox.Button className="text-base-regular relative flex w-full cursor-default items-center justify-between border px-4 py-[10px] text-left focus:outline-none focus-visible:border-gray-300 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-300">
          {({ open }) => (
            <>
        ...
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <Listbox.Options className="text-small-regular border-top-0 absolute z-20 max-h-60 w-full overflow-auto bg-background focus:outline-none sm:text-sm">
