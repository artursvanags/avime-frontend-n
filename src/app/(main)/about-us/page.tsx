...
const aboutUsText = `
  ...
  A Fresh Perspective AVIME was born from the belief that school photography
  ...
  Quality Over Quantity At AVIME, we
  ...
  pictures; we capture moments that become part of your family's legacy.
  ...
  school photography to new heights.

  Thank you for choosing AVIME, where
